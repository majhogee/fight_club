...
class FightersControllerTest < ActionController::TestCase
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post :create, fighter: { description: @fighter.description, first_name: @fighter.first_name, last_name: @fighter.last_name }
    end
  ...
  test "should update fighter" do
    patch :update, id: @fighter, fighter: { description: @fighter.description, first_name: @fighter.first_name, last_name: @fighter.last_name }
    assert_redirected_to fighter_path(assigns(:fighter))
  end
